...
The app stores the selected game folder, mods folder, database output path, and language in `stellaris_tech_browser.ini` beside the app entry point (`run.py` / packaged executable).
